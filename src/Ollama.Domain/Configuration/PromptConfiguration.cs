namespace Ollama.Domain.Configuration
{
    ...
    public class PromptConfiguration
    {
        ...
        public string OptimisticPromptFileName { get; set; } = "pessimistic-initial-system-prompt.txt";
        public string DefaultPromptFileName { get; set; } = "pessimistic-initial-system-prompt.txt";
